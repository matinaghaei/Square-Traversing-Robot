...
class PoseMonitor():
	...
	def callback_odometry(self, msg):
		...
		print("Ground Truth: ", self.get_ground_truth("turtlebot3_burger", "world"))
...
if __name__ == '__main__':
	position_monitor = PoseMonitor()
	while not position_monitor.is_finished:
		position_monitor.rate.sleep()
